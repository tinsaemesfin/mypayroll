    ...
    <?php echo display_msg($msg); ?>
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
         ...
         <form method="post" action="all_item_remaing_download_itemcode.php">
...
?>
             ...
             <td class="text-center" style=" font-weight: bold;"> <?php echo $pro_panrent ?> </td>
             <td class="text-center" style=" font-weight: bold;"> <?php echo $proo_des ?> </td>
                <td class="text-center" style=" font-weight: bold;"> <?php echo $proo_cat ?> </td>
                ...
                <td class="text-center" style=" font-weight: bold;"> <?php echo $proo_color ?> </td>
                <td class="text-center" style=" font-weight: bold;"> <?php echo $proo_date ?> </td>
